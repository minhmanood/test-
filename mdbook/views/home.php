<div class="container">
    ...
    <section class="container my-3">
        <div class="">
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="border-radius: 10px;">
                        <div class="carousel-item active">
                            <img class="img-fluid" src="upload\books-bookstore-book-reading-159711.jpeg" alt="Image">

                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid" src="upload\pexels-photo-1290141.jpeg" alt="Image">

                        </div>
                        <div class="carousel-item">
                            <img class="img-fluid" src="upload\pexels-photo-1370295.jpeg" alt="Image">
            ...
            <div class=" mx-5  row mt-4">
                <div class="product-offer col-lg-4">
                    <img class="img-fluid  " src="upload/anhdep4.jpeg" alt="">

                </div>
                <div class="product-offer col-lg-4  ">
                    <img class="img-fluid " src="upload/anhdep3.jpeg" alt="">

                </div>
                <div class="product-offer col-lg-4">
                    <img class="img-fluid " src="upload/anhdep.webp" alt="">
    ...
    <!-- Banner Section Begin -->
    <section class="banner set-bg " style="max-width: full" data-setbg="upload/hi.webp">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="discount__pic">
                        <img src="upload/cay-cam-ngot.jpg" alt="Hình ảnh">
                    </div>
                </div>
                <div class="col-lg-6 p-0 border border-dark">
                    <div class="discount__text">
                        ...
                        <div class=" border border-success " style="background: #F4F4F9;" id="countdown-time">
                            <div class="">
                                <span>22</span>
                                <p>Ngày</p>
                            </div>
