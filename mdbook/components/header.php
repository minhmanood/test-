<body>
    ...
    <header class="header">
        <div class="container ">
            <div class="text-center mb-2 row border-bottom border-dark">
                <div class="header__logo col-lg-3">

                    <a href="index.php">
                        <img style="max-height: 80px;" src="upload/logo.jpeg" alt="">

                    </a>
                </div>
                <div class="col-7 text-center ">
                    <h3 class="pt-5 pb-3 ">Man STORE</h3>
                </div>
            </div>
            <div class="row bg-dark text-white ">

                <div class="col-xl-6 col-lg-7 ">
                    <nav class="header__menu text-white">
                        <ul>
                            <li><a class="text-white" href="index.php">TRANG CHỦ</a></li>

                            <li><a class="text-white" href="index.php?url=cua-hang">Cửa hàng</a></li>

                            <li><a class="text-white" href="index.php?url=bai-viet">Bài viết</a></li>
                            <!-- <li><a href="./blog.html">bÀI viẾT</a></li> -->
                            <li><a class="text-white" href="index.php?url=lien-he">LIÊN HỆ</a></li>

                            <li><a class="text-white" href="#">Trang</a>
                                <ul class="dropdown">
                    ...
                    <div class="header__right">
                        ...
                        <?php if (isset($_SESSION['user'])) { ?>
                            <div class="header__right__auth acount">
                                <a style="color: aliceblue;" href="index.php?url=thong-tin-tai-khoan">
                                    <img style="color: aliceblue;" src="upload/<?= $_SESSION['user']['image'] ?>" alt=""><?= $_SESSION['user']['username'] ?>
                                </a>
                        ...
                        ?>
                            <div class="header__right__auth ">
                                <a class="text-white" href="index.php?url=dang-nhap">Đăng nhập</a>
                                <a class="text-white" href="index.php?url=dang-ky">Đăng ký</a>
                            </div>
                        <?php
                        }
                        ?>
